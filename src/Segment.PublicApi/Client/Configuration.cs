...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 61.1.4";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  61.1.4 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 61.1.4\n";
            report += "    SDK Package Version:  61.1.4\n";
