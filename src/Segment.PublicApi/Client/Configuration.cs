...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 61.3.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  61.3.0 (C#)");
            BasePath = "https://api.segmentapis.com";
        ...
        public Configuration(
            ...
            string basePath = "https://api.segmentapis.com") : this()
        {
        ...
        {
            string report = "C# SDK (Segment.PublicApi) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 61.3.0\n";
            report += "    SDK Package Version:  61.3.0\n";
