...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 70.0.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  70.0.0 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 70.0.0\n";
            report += "    SDK Package Version:  70.0.0\n";
