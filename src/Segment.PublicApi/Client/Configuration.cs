...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 73.4.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  73.4.1 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 73.4.1\n";
            report += "    SDK Package Version:  73.4.1\n";
