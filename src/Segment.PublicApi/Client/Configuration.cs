...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 58.1.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  58.1.1 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 58.1.1\n";
            report += "    SDK Package Version:  58.1.1\n";
