...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 73.0.7";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  73.0.7 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 73.0.7\n";
            report += "    SDK Package Version:  73.0.7\n";
