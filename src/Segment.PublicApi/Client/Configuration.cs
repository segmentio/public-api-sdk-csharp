...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 59.2.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  59.2.0 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 59.2.0\n";
            report += "    SDK Package Version:  59.2.0\n";
