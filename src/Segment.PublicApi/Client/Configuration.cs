...
namespace Segment.PublicApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = " 62.0.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("Public API SDK  62.0.0 (C#)");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 62.0.0\n";
            report += "    SDK Package Version:  62.0.0\n";
