...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ScheduleConfigJsonConverter))]
    [DataContract(Name = "scheduleConfig")]
    public partial class ScheduleConfig : AbstractOpenAPISchema, IEquatable<ScheduleConfig>, IValidatableObject
    {
        /// <summary>
        ...
        public ScheduleConfig(ReverseEtlPeriodicScheduleConfig actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "anyOf";
        ...
        public ScheduleConfig(ReverseEtlSpecificTimeScheduleConfig actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "anyOf";
            this.ActualInstance = actualInstance;
        ...
        public ScheduleConfig(ReverseEtlCronScheduleConfig actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "anyOf";
            this.ActualInstance = actualInstance;
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ScheduleConfig.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ScheduleConfig
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ScheduleConfig</returns>
        public static ScheduleConfig FromJson(string jsonString)
        {
            ScheduleConfig newScheduleConfig = null;
            ...
            try
            {
                newScheduleConfig = new ScheduleConfig(JsonConvert.DeserializeObject<ReverseEtlCronScheduleConfig>(jsonString, ScheduleConfig.SerializerSettings));
            ...
            try
            {
                newScheduleConfig = new ScheduleConfig(JsonConvert.DeserializeObject<ReverseEtlPeriodicScheduleConfig>(jsonString, ScheduleConfig.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newScheduleConfig;
            }
            catch (Exception exception)
            ...
            try
            {
                newScheduleConfig = new ScheduleConfig(JsonConvert.DeserializeObject<ReverseEtlSpecificTimeScheduleConfig>(jsonString, ScheduleConfig.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newScheduleConfig;
            }
            catch (Exception exception)
        ...
        /// <summary>
        /// Returns true if ScheduleConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleConfig to be compared</param>
        /// <returns>Boolean</returns>
    ...
    /// <summary>
    /// Custom JSON converter for ScheduleConfig
    /// </summary>
    public class ScheduleConfigJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ScheduleConfig).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ScheduleConfig.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
