...
namespace Segment.PublicApi.Model
{
    ...
    public partial class ScheduleConfig : AbstractOpenAPISchema, IEquatable<ScheduleConfig>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ReverseEtlPeriodicScheduleConfig))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ReverseEtlPeriodicScheduleConfig, ReverseEtlSpecificTimeScheduleConfig");
                }
            }
        }
