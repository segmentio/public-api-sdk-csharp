...
namespace Segment.PublicApi.Model
{
    ...
    public partial class ReverseEtlModel : IEquatable<ReverseEtlModel>, IValidatableObject
    {
        ...
        /// <param name="scheduleStrategy">Determines the strategy used for triggering syncs, which will be used in conjunction with scheduleConfig.  Possible values: \&quot;manual\&quot;, \&quot;periodic\&quot;, \&quot;specific_days\&quot;. (required).</param>
        /// <param name="scheduleConfig">scheduleConfig.</param>
        ...
        public ReverseEtlModel(string id = default(string), string sourceId = default(string), string name = default(string), string description = default(string), bool enabled = default(bool), string scheduleStrategy = default(string), ScheduleConfig scheduleConfig = default(ScheduleConfig), string query = default(string), string queryIdentifierColumn = default(string))
        {
            ...
            // to ensure "scheduleStrategy" is required (not null)
            if (scheduleStrategy == null)
            {
                throw new ArgumentNullException("scheduleStrategy is a required property for ReverseEtlModel and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Determines the strategy used for triggering syncs, which will be used in conjunction with scheduleConfig.  Possible values: \&quot;manual\&quot;, \&quot;periodic\&quot;, \&quot;specific_days\&quot;.</value>
        [DataMember(Name = "scheduleStrategy", IsRequired = true, EmitDefaultValue = true)]
        public string ScheduleStrategy { get; set; }

        /// <summary>
        /// Gets or Sets ScheduleConfig
        /// </summary>
        [DataMember(Name = "scheduleConfig", EmitDefaultValue = true)]
        ...
        public bool Equals(ReverseEtlModel input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ScheduleConfig.Equals(input.ScheduleConfig))
                ) && 
                (
