...
namespace Segment.PublicApi.Model
{
    ...
    public partial class AudienceDefinition : IEquatable<AudienceDefinition>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The target entity relationship slug, only applicable for linked audiences. Use &#x60;&#x60;&#x60;profile&#x60;&#x60;&#x60; when the targeting the profile.  Note that the value defaults to profile if not specified. Also note, that the value will be returned as null if the target entity is removed from the data graph.</value>
        [DataMember(Name = "targetEntity", EmitDefaultValue = true)]
