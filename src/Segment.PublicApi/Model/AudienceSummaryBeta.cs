...
namespace Segment.PublicApi.Model
{
    ...
    /// Defines an Audience.
    /// </summary>
    [DataContract(Name = "AudienceSummaryBeta")]
    public partial class AudienceSummaryBeta : IEquatable<AudienceSummaryBeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceSummaryBeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AudienceSummaryBeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceSummaryBeta" /> class.
        /// </summary>
        ...
        public AudienceSummaryBeta(string id = default(string), string spaceId = default(string), string name = default(string), string description = default(string), string key = default(string), bool enabled = default(bool), AudienceDefinitionBeta definition = default(AudienceDefinitionBeta), string status = default(string), string createdBy = default(string), string updatedBy = default(string), string createdAt = default(string), string updatedAt = default(string), AudienceOptionsBeta options = default(AudienceOptionsBeta))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.Id = id;
            // to ensure "spaceId" is required (not null)
            if (spaceId == null)
            {
                throw new ArgumentNullException("spaceId is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.SpaceId = spaceId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.Name = name;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.Key = key;
            ...
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.Definition = definition;
            // to ensure "createdBy" is required (not null)
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.CreatedBy = createdBy;
            // to ensure "updatedBy" is required (not null)
            if (updatedBy == null)
            {
                throw new ArgumentNullException("updatedBy is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.UpdatedBy = updatedBy;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for AudienceSummaryBeta and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for AudienceSummaryBeta and cannot be null");
            }
        ...
        public AudienceDefinitionBeta Definition { get; set; }
        ...
        public AudienceOptionsBeta Options { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceSummaryBeta {\n");
        ...
        {
            return this.Equals(input as AudienceSummaryBeta);
        }

        /// <summary>
        /// Returns true if AudienceSummaryBeta instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceSummaryBeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceSummaryBeta input)
        {
            if (input == null)
            {
                return false;
