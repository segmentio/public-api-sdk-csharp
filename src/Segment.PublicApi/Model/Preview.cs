...
namespace Segment.PublicApi.Model
{
    ...
    public partial class Preview : IEquatable<Preview>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Preview" /> class.
        /// </summary>
        /// <param name="id">Unique identifier for tracking and retrieving results of the preview. (required).</param>
        public Preview(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Preview and cannot be null");
            }
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>Unique identifier for tracking and retrieving results of the preview.</value>
