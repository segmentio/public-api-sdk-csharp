...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAudienceInput")]
    public partial class CreateAudienceInput : IEquatable<CreateAudienceInput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudienceInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAudienceInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudienceInput" /> class.
        /// </summary>
        ...
        public CreateAudienceInput(string name = default(string), bool enabled = default(bool), string description = default(string), AudienceDefinition definition = default(AudienceDefinition), AudienceTypeEnum audienceType = default(AudienceTypeEnum), AudienceOptions options = default(AudienceOptions))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateAudienceInput and cannot be null");
            }
            this.Name = name;
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for CreateAudienceInput and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAudienceInput {\n");
        ...
        {
            return this.Equals(input as CreateAudienceInput);
        }

        /// <summary>
        /// Returns true if CreateAudienceInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAudienceInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAudienceInput input)
        {
            if (input == null)
            {
                return false;
