...
namespace Segment.PublicApi.Model
{
    ...
    public partial class EdgeFunctionsAlpha : IEquatable<EdgeFunctionsAlpha>, IValidatableObject
    {
        ...
        /// <param name="code">The code of the Edge Function..</param>
        public EdgeFunctionsAlpha(string id = default(string), string sourceId = default(string), string createdAt = default(string), string createdBy = default(string), string downloadURL = default(string), decimal varVersion = default(decimal), string code = default(string))
        {
        ...
        /// </summary>
        /// <value>The code of the Edge Function.</value>
