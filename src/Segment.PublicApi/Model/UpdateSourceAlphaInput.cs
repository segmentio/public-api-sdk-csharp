...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateSourceAlphaInput")]
    public partial class UpdateSourceAlphaInput : IEquatable<UpdateSourceAlphaInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSourceAlphaInput" /> class.
        /// </summary>
        ...
        public UpdateSourceAlphaInput(string name = default(string), bool enabled = default(bool), string slug = default(string), Dictionary<string, Object> settings = default(Dictionary<string, Object>))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateSourceAlphaInput);
        }

        /// <summary>
        /// Returns true if UpdateSourceAlphaInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSourceAlphaInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSourceAlphaInput input)
        {
            if (input == null)
            {
                return false;
