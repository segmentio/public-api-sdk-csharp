...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateAudienceScheduleForAudienceAlphaInput")]
    public partial class UpdateAudienceScheduleForAudienceAlphaInput : IEquatable<UpdateAudienceScheduleForAudienceAlphaInput>, IValidatableObject
    {
        ...
        protected UpdateAudienceScheduleForAudienceAlphaInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAudienceScheduleForAudienceAlphaInput" /> class.
        /// </summary>
        ...
        public UpdateAudienceScheduleForAudienceAlphaInput(StrategyEnum strategy = default(StrategyEnum), Config config = default(Config))
        {
            ...
            if (config == null)
            {
                throw new ArgumentNullException("config is a required property for UpdateAudienceScheduleForAudienceAlphaInput and cannot be null");
            }
            this.Config = config;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAudienceScheduleForAudienceAlphaInput {\n");
        ...
        {
            return this.Equals(input as UpdateAudienceScheduleForAudienceAlphaInput);
        }

        /// <summary>
        /// Returns true if UpdateAudienceScheduleForAudienceAlphaInput instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAudienceScheduleForAudienceAlphaInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAudienceScheduleForAudienceAlphaInput input)
        {
            if (input == null)
            {
                return false;
