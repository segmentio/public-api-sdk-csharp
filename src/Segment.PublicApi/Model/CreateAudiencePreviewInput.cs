...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAudiencePreviewInput")]
    public partial class CreateAudiencePreviewInput : IEquatable<CreateAudiencePreviewInput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudiencePreviewInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAudiencePreviewInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudiencePreviewInput" /> class.
        /// </summary>
        ...
        public CreateAudiencePreviewInput(AudienceDefinition definition = default(AudienceDefinition), AudienceTypeEnum audienceType = default(AudienceTypeEnum), CreateAudiencePreviewOptions options = default(CreateAudiencePreviewOptions))
        {
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for CreateAudiencePreviewInput and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateAudiencePreviewInput);
        }

        /// <summary>
        /// Returns true if CreateAudiencePreviewInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAudiencePreviewInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAudiencePreviewInput input)
        {
            if (input == null)
            {
                return false;
