...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityProfileDetails")]
    public partial class EntityProfileDetails : IEquatable<EntityProfileDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityProfileDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EntityProfileDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityProfileDetails" /> class.
        /// </summary>
        ...
        public EntityProfileDetails(string id = default(string), string idProperty = default(string), string relationshipSlug = default(string), Dictionary<string, Object> properties = default(Dictionary<string, Object>), Dictionary<string, Object> entities = default(Dictionary<string, Object>), List<Profile> profiles = default(List<Profile>), bool profilesTruncated = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for EntityProfileDetails and cannot be null");
            }
            this.Id = id;
            // to ensure "idProperty" is required (not null)
            if (idProperty == null)
            {
                throw new ArgumentNullException("idProperty is a required property for EntityProfileDetails and cannot be null");
            }
            this.IdProperty = idProperty;
            // to ensure "relationshipSlug" is required (not null)
            if (relationshipSlug == null)
            {
                throw new ArgumentNullException("relationshipSlug is a required property for EntityProfileDetails and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityProfileDetails {\n");
        ...
        {
            return this.Equals(input as EntityProfileDetails);
        }

        /// <summary>
        /// Returns true if EntityProfileDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityProfileDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityProfileDetails input)
        {
            if (input == null)
            {
                return false;
