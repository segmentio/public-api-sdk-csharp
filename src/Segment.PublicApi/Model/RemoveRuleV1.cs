...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemoveRuleV1")]
    public partial class RemoveRuleV1 : IEquatable<RemoveRuleV1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveRuleV1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemoveRuleV1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveRuleV1" /> class.
        /// </summary>
        ...
        public RemoveRuleV1(TypeEnum type = default(TypeEnum), string key = default(string), decimal varVersion = default(decimal))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as RemoveRuleV1);
        }

        /// <summary>
        /// Returns true if RemoveRuleV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveRuleV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveRuleV1 input)
        {
            if (input == null)
            {
                return false;
