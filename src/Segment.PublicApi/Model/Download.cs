...
namespace Segment.PublicApi.Model
{
    ...
    public partial class Download : IEquatable<Download>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Download" /> class.
        /// </summary>
        /// <param name="urls">List of presigned URLs from S3. (required).</param>
        public Download(List<string> urls = default(List<string>))
        {
            // to ensure "urls" is required (not null)
            if (urls == null)
            {
                throw new ArgumentNullException("urls is a required property for Download and cannot be null");
            }
            this.Urls = urls;
        }
        ...
        /// </summary>
        /// <value>List of presigned URLs from S3.</value>
