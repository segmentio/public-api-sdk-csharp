...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAudiencePreviewAlphaInput")]
    public partial class CreateAudiencePreviewAlphaInput : IEquatable<CreateAudiencePreviewAlphaInput>, IValidatableObject
    {
        ...
        protected CreateAudiencePreviewAlphaInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudiencePreviewAlphaInput" /> class.
        /// </summary>
        ...
        public CreateAudiencePreviewAlphaInput(AudienceDefinitionWithoutType definition = default(AudienceDefinitionWithoutType), AudienceTypeEnum audienceType = default(AudienceTypeEnum), AudienceOptionsWithLookback options = default(AudienceOptionsWithLookback))
        {
            // to ensure "definition" is required (not null)
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for CreateAudiencePreviewAlphaInput and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateAudiencePreviewAlphaInput);
        }

        /// <summary>
        /// Returns true if CreateAudiencePreviewAlphaInput instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAudiencePreviewAlphaInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAudiencePreviewAlphaInput input)
        {
            if (input == null)
            {
                return false;
