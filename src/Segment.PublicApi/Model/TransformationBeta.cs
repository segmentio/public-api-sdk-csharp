...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransformationBeta")]
    public partial class TransformationBeta : IEquatable<TransformationBeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransformationBeta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransformationBeta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransformationBeta" /> class.
        /// </summary>
        ...
        public TransformationBeta(string id = default(string), string name = default(string), string sourceId = default(string), string destinationMetadataId = default(string), bool enabled = default(bool), string varIf = default(string), string newEventName = default(string), List<PropertyRenameBeta> propertyRenames = default(List<PropertyRenameBeta>), List<PropertyValueTransformationBeta> propertyValueTransformations = default(List<PropertyValueTransformationBeta>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TransformationBeta and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TransformationBeta and cannot be null");
            }
            this.Name = name;
            // to ensure "sourceId" is required (not null)
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for TransformationBeta and cannot be null");
            }
            ...
            if (varIf == null)
            {
                throw new ArgumentNullException("varIf is a required property for TransformationBeta and cannot be null");
            }
            this.VarIf = varIf;
        ...
        {
            return this.Equals(input as TransformationBeta);
        }

        /// <summary>
        /// Returns true if TransformationBeta instances are equal
        /// </summary>
        /// <param name="input">Instance of TransformationBeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransformationBeta input)
        {
            if (input == null)
            {
                return false;
