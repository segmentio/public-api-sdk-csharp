...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RuleInputV1")]
    public partial class RuleInputV1 : IEquatable<RuleInputV1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleInputV1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RuleInputV1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleInputV1" /> class.
        /// </summary>
        ...
        public RuleInputV1(TypeEnum type = default(TypeEnum), string key = default(string), Object jsonSchema = default(Object), decimal varVersion = default(decimal))
        {
            this.Type = type;
            // to ensure "jsonSchema" is required (not null)
            if (jsonSchema == null)
            {
                throw new ArgumentNullException("jsonSchema is a required property for RuleInputV1 and cannot be null");
            }
        ...
        {
            return this.Equals(input as RuleInputV1);
        }

        /// <summary>
        /// Returns true if RuleInputV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RuleInputV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleInputV1 input)
        {
            if (input == null)
            {
                return false;
