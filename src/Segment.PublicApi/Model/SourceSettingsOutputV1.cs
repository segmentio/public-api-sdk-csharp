...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SourceSettingsOutputV1")]
    public partial class SourceSettingsOutputV1 : IEquatable<SourceSettingsOutputV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceSettingsOutputV1" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SourceSettingsOutputV1 {\n");
        ...
        {
            return this.Equals(input as SourceSettingsOutputV1);
        }

        /// <summary>
        /// Returns true if SourceSettingsOutputV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceSettingsOutputV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceSettingsOutputV1 input)
        {
            if (input == null)
            {
                return false;
