...
namespace Segment.PublicApi.Model
{
    ...
    public partial class UpdateAudienceForSpaceInput : IEquatable<UpdateAudienceForSpaceInput>, IValidatableObject
    {
        ...
        public UpdateAudienceForSpaceInput(bool enabled = default(bool), string name = default(string), string description = default(string), AudienceDefinitionWithoutTargetEntity definition = default(AudienceDefinitionWithoutTargetEntity), AudienceOptions options = default(AudienceOptions))
        {
