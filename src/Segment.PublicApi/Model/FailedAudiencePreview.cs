...
namespace Segment.PublicApi.Model
{
    ...
    public partial class FailedAudiencePreview : IEquatable<FailedAudiencePreview>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedAudiencePreview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FailedAudiencePreview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedAudiencePreview" /> class.
        /// </summary>
        ...
        public FailedAudiencePreview(StatusEnum status = default(StatusEnum), string failureReason = default(string), string id = default(string), AudienceTypeEnum audienceType = default(AudienceTypeEnum), AudienceDefinitionWithoutType definition = default(AudienceDefinitionWithoutType), AudiencePreviewOptions options = default(AudiencePreviewOptions))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FailedAudiencePreview and cannot be null");
            }
            this.Id = id;
            ...
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for FailedAudiencePreview and cannot be null");
            }
            this.Definition = definition;
            // to ensure "options" is required (not null)
            if (options == null)
            {
                throw new ArgumentNullException("options is a required property for FailedAudiencePreview and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FailedAudiencePreview {\n");
        ...
        {
            return this.Equals(input as FailedAudiencePreview);
        }

        /// <summary>
        /// Returns true if FailedAudiencePreview instances are equal
        /// </summary>
        /// <param name="input">Instance of FailedAudiencePreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FailedAudiencePreview input)
        {
            if (input == null)
            {
                return false;
