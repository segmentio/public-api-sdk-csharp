...
namespace Segment.PublicApi.Model
{
    ...
    public partial class ActivationOutput : IEquatable<ActivationOutput>, IValidatableObject
    {
        ...
        /// <param name="activationType">Determines when an event is sent to the Destination.  Possible values: Audience Entered: Sends an event when a profile enters the audience. Audience Exited: Sends an event when a profile exits the audience. Audience Membership Changed: Sends an event for both profile entries and profile exits. Entity Added: Sends an event when an entity enters the audience. Entity Removed: Sends an event when an entity exits the audience. (required).</param>
        /// <param name="activationName">Activation name. For Warehouse Destinations, this is the table name. (required).</param>
        /// <param name="displayName">Human-readable label for the activation. Only present for Warehouse Destinations that have a display name configured. When null, the activationName serves as the label..</param>
        ...
        /// </summary>
        /// <value>Determines when an event is sent to the Destination.  Possible values: Audience Entered: Sends an event when a profile enters the audience. Audience Exited: Sends an event when a profile exits the audience. Audience Membership Changed: Sends an event for both profile entries and profile exits. Entity Added: Sends an event when an entity enters the audience. Entity Removed: Sends an event when an entity exits the audience.</value>
        ...
        /// </summary>
        /// <value>Activation name. For Warehouse Destinations, this is the table name.</value>
        ...
        /// </summary>
        /// <value>Human-readable label for the activation. Only present for Warehouse Destinations that have a display name configured. When null, the activationName serves as the label.</value>
        ...
        public PersonalizationOutput Personalization { get; set; }
