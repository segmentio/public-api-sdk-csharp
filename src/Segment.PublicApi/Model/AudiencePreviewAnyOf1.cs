...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AudiencePreview_anyOf_1")]
    public partial class AudiencePreviewAnyOf1 : IEquatable<AudiencePreviewAnyOf1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudiencePreviewAnyOf1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AudiencePreviewAnyOf1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AudiencePreviewAnyOf1" /> class.
        /// </summary>
        ...
        public AudiencePreviewAnyOf1(StatusEnum status = default(StatusEnum), string id = default(string), AudienceTypeEnum audienceType = default(AudienceTypeEnum), AudienceDefinitionWithoutType definition = default(AudienceDefinitionWithoutType), AudiencePreviewOptions options = default(AudiencePreviewOptions))
        {
            this.Status = status;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AudiencePreviewAnyOf1 and cannot be null");
            }
            this.Id = id;
            ...
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for AudiencePreviewAnyOf1 and cannot be null");
            }
            this.Definition = definition;
            // to ensure "options" is required (not null)
            if (options == null)
            {
                throw new ArgumentNullException("options is a required property for AudiencePreviewAnyOf1 and cannot be null");
            }
        ...
        {
            return this.Equals(input as AudiencePreviewAnyOf1);
        }

        /// <summary>
        /// Returns true if AudiencePreviewAnyOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AudiencePreviewAnyOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudiencePreviewAnyOf1 input)
        {
            if (input == null)
            {
                return false;
