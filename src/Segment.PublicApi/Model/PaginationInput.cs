...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaginationInput")]
    public partial class PaginationInput : IEquatable<PaginationInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationInput" /> class.
        /// </summary>
        ...
        /// <param name="count">The number of items to retrieve in a page, between 1 and 1000. (required).</param>
        public PaginationInput(string cursor = default(string), int count = default(int))
        {
            this.Count = count;
            this.Cursor = cursor;
        }
        ...
        /// </summary>
        /// <value>The number of items to retrieve in a page, between 1 and 1000.</value>
        ...
        {
            return this.Equals(input as PaginationInput);
        }

        /// <summary>
        /// Returns true if PaginationInput instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginationInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginationInput input)
        {
            if (input == null)
            {
                return false;
