...
namespace Segment.PublicApi.Model
{
    ...
    public partial class Connection : IEquatable<Connection>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Connection" /> class.
        /// </summary>
        /// <param name="id">The id of the connection that was created. (required).</param>
        public Connection(string id = default(string))
        {
        ...
        /// </summary>
        /// <value>The id of the connection that was created.</value>
