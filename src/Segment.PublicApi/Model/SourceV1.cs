...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SourceV1")]
    public partial class SourceV1 : IEquatable<SourceV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceV1" /> class.
        /// </summary>
        ...
        public SourceV1(string id = default(string), string slug = default(string), string name = default(string), SourceMetadataV1 metadata = default(SourceMetadataV1), string workspaceId = default(string), bool enabled = default(bool), List<string> writeKeys = default(List<string>), Dictionary<string, Object> settings = default(Dictionary<string, Object>), List<LabelV1> labels = default(List<LabelV1>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SourceV1 and cannot be null");
            }
            this.Id = id;
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for SourceV1 and cannot be null");
            }
            this.Slug = slug;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for SourceV1 and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "workspaceId" is required (not null)
            if (workspaceId == null)
            {
                throw new ArgumentNullException("workspaceId is a required property for SourceV1 and cannot be null");
            }
            ...
            if (writeKeys == null)
            {
                throw new ArgumentNullException("writeKeys is a required property for SourceV1 and cannot be null");
            }
            this.WriteKeys = writeKeys;
            // to ensure "labels" is required (not null)
            if (labels == null)
            {
                throw new ArgumentNullException("labels is a required property for SourceV1 and cannot be null");
            }
            this.Labels = labels;
            this.Name = name;
        ...
        {
            return this.Equals(input as SourceV1);
        }

        /// <summary>
        /// Returns true if SourceV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceV1 input)
        {
            if (input == null)
            {
                return false;
