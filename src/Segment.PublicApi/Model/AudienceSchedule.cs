...
namespace Segment.PublicApi.Model
{
    ...
    public partial class AudienceSchedule : IEquatable<AudienceSchedule>, IValidatableObject
    {
        ...
        /// <param name="enabled">Whether the schedule is enabled. (required).</param>
        /// <param name="nextExecution">The next scheduled execution time (RFC3339). (required).</param>
        public AudienceSchedule(string id = default(string), StrategyEnum strategy = default(StrategyEnum), Config config = default(Config), bool enabled = default(bool), string nextExecution = default(string))
        {
            ...
            // to ensure "nextExecution" is required (not null)
            if (nextExecution == null)
            {
                throw new ArgumentNullException("nextExecution is a required property for AudienceSchedule and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Whether the schedule is enabled.</value>
        ...
        [DataMember(Name = "nextExecution", IsRequired = true, EmitDefaultValue = true)]
