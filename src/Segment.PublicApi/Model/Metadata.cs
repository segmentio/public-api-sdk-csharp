...
namespace Segment.PublicApi.Model
{
    ...
    public partial class Metadata : IEquatable<Metadata>, IValidatableObject
    {
        ...
        public Metadata(string id = default(string), string name = default(string), string slug = default(string))
        {
            ...
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for Metadata and cannot be null");
            }
            this.Slug = slug;
        }
