...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompletedAudiencePreview")]
    public partial class CompletedAudiencePreview : IEquatable<CompletedAudiencePreview>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompletedAudiencePreview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompletedAudiencePreview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompletedAudiencePreview" /> class.
        /// </summary>
        ...
        public CompletedAudiencePreview(StatusEnum status = default(StatusEnum), List<AudiencePreviewResult> results = default(List<AudiencePreviewResult>), AudienceSize size = default(AudienceSize), string id = default(string), AudienceTypeEnum audienceType = default(AudienceTypeEnum), AudienceDefinitionWithoutType definition = default(AudienceDefinitionWithoutType), AudiencePreviewOptions options = default(AudiencePreviewOptions))
        {
            this.Status = status;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for CompletedAudiencePreview and cannot be null");
            }
            this.Results = results;
            // to ensure "size" is required (not null)
            if (size == null)
            {
                throw new ArgumentNullException("size is a required property for CompletedAudiencePreview and cannot be null");
            }
            this.Size = size;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CompletedAudiencePreview and cannot be null");
            }
            this.Id = id;
            ...
            if (definition == null)
            {
                throw new ArgumentNullException("definition is a required property for CompletedAudiencePreview and cannot be null");
            }
            this.Definition = definition;
            // to ensure "options" is required (not null)
            if (options == null)
            {
                throw new ArgumentNullException("options is a required property for CompletedAudiencePreview and cannot be null");
            }
        ...
        {
            return this.Equals(input as CompletedAudiencePreview);
        }

        /// <summary>
        /// Returns true if CompletedAudiencePreview instances are equal
        /// </summary>
        /// <param name="input">Instance of CompletedAudiencePreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompletedAudiencePreview input)
        {
            if (input == null)
            {
                return false;
