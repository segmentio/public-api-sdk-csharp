...
namespace Segment.PublicApi.Model
{
    ...
    public partial class CreateAudiencePreviewBetaInput : IEquatable<CreateAudiencePreviewBetaInput>, IValidatableObject
    {
        ...
        public CreateAudiencePreviewBetaInput(AudienceDefinitionWithoutType definition = default(AudienceDefinitionWithoutType), AudienceTypeEnum audienceType = default(AudienceTypeEnum), CreateAudiencePreviewOptions options = default(CreateAudiencePreviewOptions))
        {
