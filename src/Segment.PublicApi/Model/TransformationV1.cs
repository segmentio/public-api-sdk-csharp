...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransformationV1")]
    public partial class TransformationV1 : IEquatable<TransformationV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransformationV1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransformationV1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransformationV1" /> class.
        /// </summary>
        /// <param name="id">The id of the Transformation. (required).</param>
        /// <param name="name">The name of the Transformation. (required).</param>
        /// <param name="sourceId">The Source associated with the Transformation. (required).</param>
        /// <param name="destinationMetadataId">The optional Destination metadata associated with the Transformation..</param>
        /// <param name="enabled">If the Transformation is enabled. (required).</param>
        ...
        /// <param name="fqlDefinedProperties">Optional array for defining new properties in FQL. Limited to 1 property right now..</param>
        ...
        public TransformationV1(string id = default(string), string name = default(string), string sourceId = default(string), string destinationMetadataId = default(string), bool enabled = default(bool), string varIf = default(string), string newEventName = default(string), List<PropertyRenameV1> propertyRenames = default(List<PropertyRenameV1>), List<PropertyValueTransformationV1> propertyValueTransformations = default(List<PropertyValueTransformationV1>), List<FQLDefinedPropertyV1> fqlDefinedProperties = default(List<FQLDefinedPropertyV1>), List<string> allowProperties = default(List<string>), HashPropertiesConfiguration hashPropertiesConfiguration = default(HashPropertiesConfiguration))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TransformationV1 and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TransformationV1 and cannot be null");
            }
            this.Name = name;
            // to ensure "sourceId" is required (not null)
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for TransformationV1 and cannot be null");
            }
            ...
            if (varIf == null)
            {
                throw new ArgumentNullException("varIf is a required property for TransformationV1 and cannot be null");
            }
            this.VarIf = varIf;
        ...
        /// </summary>
        /// <value>The id of the Transformation.</value>
        ...
        /// </summary>
        /// <value>The Source associated with the Transformation.</value>
        ...
        /// </summary>
        /// <value>The optional Destination metadata associated with the Transformation.</value>
        ...
        /// </summary>
        /// <value>If the Transformation is enabled.</value>
        ...
        /// </summary>
        /// <value>Optional array for defining new properties in FQL. Limited to 1 property right now.</value>
        ...
        {
            return this.Equals(input as TransformationV1);
        }

        /// <summary>
        /// Returns true if TransformationV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransformationV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransformationV1 input)
        {
            if (input == null)
            {
                return false;
