...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateTransformationV1Input")]
    public partial class UpdateTransformationV1Input : IEquatable<UpdateTransformationV1Input>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTransformationV1Input" /> class.
        /// </summary>
        ...
        /// <param name="fqlDefinedProperties">Optional array for updating properties defined in [FQL](https://segment.com/docs/config-api/fql/). Currently limited to 1 property..</param>
        ...
        /// </summary>
        /// <value>Optional array for updating properties defined in [FQL](https://segment.com/docs/config-api/fql/). Currently limited to 1 property.</value>
        ...
        {
            return this.Equals(input as UpdateTransformationV1Input);
        }

        /// <summary>
        /// Returns true if UpdateTransformationV1Input instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateTransformationV1Input to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateTransformationV1Input input)
        {
            if (input == null)
            {
                return false;
