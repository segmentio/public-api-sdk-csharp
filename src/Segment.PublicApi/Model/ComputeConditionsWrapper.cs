...
namespace Segment.PublicApi.Model
{
    ...
    public partial class ComputeConditionsWrapper : IEquatable<ComputeConditionsWrapper>, IValidatableObject
    {
        ...
        /// <param name="conditions">The query language string or AST object defining the audience segmentation criteria. When format is &#39;AST&#39;, this should be an object. When format is &#39;CQL&#39;, this should be a string. Validation is handled at the business logic level due to conditional nature. (required).</param>
        public ComputeConditionsWrapper(FormatEnum format = default(FormatEnum), Object conditions = default(Object))
        {
            this.Format = format;
        ...
        /// </summary>
        /// <value>The query language string or AST object defining the audience segmentation criteria. When format is &#39;AST&#39;, this should be an object. When format is &#39;CQL&#39;, this should be a string. Validation is handled at the business logic level due to conditional nature.</value>
