...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComputedTraitsDefinition")]
    public partial class ComputedTraitsDefinition : IEquatable<ComputedTraitsDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComputedTraitsDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComputedTraitsDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComputedTraitsDefinition" /> class.
        /// </summary>
        ...
        public ComputedTraitsDefinition(string query = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "query" is required (not null)
            if (query == null)
            {
                throw new ArgumentNullException("query is a required property for ComputedTraitsDefinition and cannot be null");
            }
            this.Query = query;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as ComputedTraitsDefinition);
        }

        /// <summary>
        /// Returns true if ComputedTraitsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of ComputedTraitsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComputedTraitsDefinition input)
        {
            if (input == null)
            {
                return false;
