...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCredentialV1Output")]
    public partial class GetCredentialV1Output : IEquatable<GetCredentialV1Output>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCredentialV1Output" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCredentialV1Output() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCredentialV1Output" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetCredentialV1Output);
        }

        /// <summary>
        /// Returns true if GetCredentialV1Output instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCredentialV1Output to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCredentialV1Output input)
        {
            if (input == null)
            {
                return false;
