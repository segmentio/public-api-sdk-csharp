...
namespace Segment.PublicApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListActivationsAlphaOutput")]
    public partial class ListActivationsAlphaOutput : IEquatable<ListActivationsAlphaOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivationsAlphaOutput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListActivationsAlphaOutput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivationsAlphaOutput" /> class.
        /// </summary>
        ...
        public ListActivationsAlphaOutput(List<ActivationOutput> activations = default(List<ActivationOutput>), PaginationOutput pagination = default(PaginationOutput))
        {
            ...
            if (activations == null)
            {
                throw new ArgumentNullException("activations is a required property for ListActivationsAlphaOutput and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListActivationsAlphaOutput);
        }

        /// <summary>
        /// Returns true if ListActivationsAlphaOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of ListActivationsAlphaOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListActivationsAlphaOutput input)
        {
            if (input == null)
            {
                return false;
