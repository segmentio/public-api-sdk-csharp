...
namespace Segment.PublicApi.Model
{
    ...
    public partial class ReverseEtlDbtCloudScheduleConfig : IEquatable<ReverseEtlDbtCloudScheduleConfig>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ReverseEtlDbtCloudScheduleConfig" /> class.
        /// </summary>
        /// <param name="jobId">The dbt cloud job id used to start a reverse ETL sync. (required).</param>
        /// <param name="accountId">The dbt cloud account id where the job belongs to. (required).</param>
        ...
        /// </summary>
        /// <value>The dbt cloud job id used to start a reverse ETL sync.</value>
        ...
        /// </summary>
        /// <value>The dbt cloud account id where the job belongs to.</value>
