...
namespace Segment.PublicApi.Model
{
    ...
    public partial class AudienceExitRule : IEquatable<AudienceExitRule>, IValidatableObject
    {
        ...
        public AudienceExitRule(ExitTypeEnum exitType = default(ExitTypeEnum), string audienceId = default(string), TypeEnum type = default(TypeEnum), bool enabled = default(bool), bool concurrencyEnabled = default(bool), List<Transitions> transitions = default(List<Transitions>), Key key = default(Key))
        {
