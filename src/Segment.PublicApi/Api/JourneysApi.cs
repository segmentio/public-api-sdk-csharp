...
namespace Segment.PublicApi.Api
{
    ...
    public interface IJourneysApiSync : IApiAccessor
    {
        ...
        /// <returns>CreateJourney200Response</returns>
        CreateJourney200Response CreateJourney(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0);
        ...
        /// <param name="createJourneyAlphaInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateJourney200Response</returns>
        ApiResponse<CreateJourney200Response> CreateJourneyWithHttpInfo(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0);
    ...
    public interface IJourneysApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of CreateJourney200Response</returns>
        System.Threading.Tasks.Task<CreateJourney200Response> CreateJourneyAsync(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateJourney200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<CreateJourney200Response>> CreateJourneyWithHttpInfoAsync(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class JourneysApi : IJourneysApi
    {
        ...
        /// <summary>
        /// Create Journey Creates a Journey in the given Engage space. Accepts an XState journey definition and creates the journey in draft state.  • This endpoint is in **Alpha** testing.  Please submit any feedback by sending an email to friends@segment.com. 
        /// </summary>
        /// <exception cref="Segment.PublicApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="spaceId"></param>
        /// <param name="createJourneyAlphaInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateJourney200Response</returns>
        public CreateJourney200Response CreateJourney(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0)
        {
            Segment.PublicApi.Client.ApiResponse<CreateJourney200Response> localVarResponse = CreateJourneyWithHttpInfo(spaceId, createJourneyAlphaInput);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateJourney200Response</returns>
        public Segment.PublicApi.Client.ApiResponse<CreateJourney200Response> CreateJourneyWithHttpInfo(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<CreateJourney200Response>("/spaces/{spaceId}/journeys", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateJourney200Response</returns>
        public async System.Threading.Tasks.Task<CreateJourney200Response> CreateJourneyAsync(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Segment.PublicApi.Client.ApiResponse<CreateJourney200Response> localVarResponse = await CreateJourneyWithHttpInfoAsync(spaceId, createJourneyAlphaInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Segment.PublicApi.Client.ApiResponse<CreateJourney200Response>> CreateJourneyWithHttpInfoAsync(string spaceId, CreateJourneyAlphaInput createJourneyAlphaInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<CreateJourney200Response>("/spaces/{spaceId}/journeys", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
