...
namespace Segment.PublicApi.Api
{
    ...
    public partial class DeletionAndSuppressionApi : IDeletionAndSuppressionApi
    {
        ...
        /// <summary>
        /// Create Workspace Regulation Creates a Workspace-scoped regulation.  Config API omitted fields: - &#x60;attributes&#x60;, - &#x60;userAgent&#x60;  Rate limit headers will be updated to reflect regulation-specific limits (tracked separately for Segment-only vs Segment &amp; Destination regulation types): - X-RateLimit-Remaining: Remaining requests for the regulation type category   - Segment-only Regulations: DELETE_INTERNAL, SUPPRESS_WITH_DELETE_INTERNAL, SUPPRESS_ONLY, UNSUPPRESS, DELETE_ARCHIVE_ONLY   - Segment &amp; Destination Regulations: DELETE_ONLY, SUPPRESS_WITH_DELETE - X-RateLimit-Reset: RFC 5322 timestamp for when the quota resets (for example, Tue, 31 Dec 2024 23:59:59 GMT)   
        /// </summary>
        /// <exception cref="Segment.PublicApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createWorkspaceRegulationV1Input"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
