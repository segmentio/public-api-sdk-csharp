...
namespace Segment.PublicApi.Api
{
    ...
    public interface IAudiencesApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Segment.PublicApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="spaceId"></param>
        /// <param name="previewAudienceInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PreviewAudience200Response</returns>
        PreviewAudience200Response PreviewAudience(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0);
        ...
        /// <param name="previewAudienceInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PreviewAudience200Response</returns>
        ApiResponse<PreviewAudience200Response> PreviewAudienceWithHttpInfo(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0);
        /// <summary>
    ...
    public interface IAudiencesApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PreviewAudience200Response</returns>
        System.Threading.Tasks.Task<PreviewAudience200Response> PreviewAudienceAsync(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PreviewAudience200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<PreviewAudience200Response>> PreviewAudienceWithHttpInfoAsync(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove Audience from Space
        /// </summary>
        /// <remarks>
    ...
    public partial class AudiencesApi : IAudiencesApi
    {
        ...
        /// <summary>
        /// List Audiences Returns Audiences by spaceId.  • This endpoint is in **Beta** testing.  Please submit any feedback by sending an email to friends@segment.com.   • In order to successfully call this endpoint, the specified Workspace needs to have the Audience feature enabled. Please reach out to your customer success manager for more information.   The rate limit for this endpoint is 25 requests per minute, which is lower than the default due to access pattern restrictions. Once reached, this endpoint will respond with the 429 HTTP status code with headers indicating the limit parameters. See [Rate Limiting](/#tag/Rate-Limits) for more information.
        /// </summary>
        /// <exception cref="Segment.PublicApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="spaceId"></param>
        /// <param name="pagination">Information about the pagination of this response.  [See pagination](https://docs.segmentapis.com/tag/Pagination/#section/Pagination-parameters) for more info.  This parameter exists in alpha. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PreviewAudience200Response</returns>
        public PreviewAudience200Response PreviewAudience(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0)
        {
            Segment.PublicApi.Client.ApiResponse<PreviewAudience200Response> localVarResponse = PreviewAudienceWithHttpInfo(spaceId, previewAudienceInput);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PreviewAudience200Response</returns>
        public Segment.PublicApi.Client.ApiResponse<PreviewAudience200Response> PreviewAudienceWithHttpInfo(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
                throw new Segment.PublicApi.Client.ApiException(400, "Missing required parameter 'spaceId' when calling AudiencesApi->PreviewAudience");
            }

            // verify the required parameter 'previewAudienceInput' is set
            if (previewAudienceInput == null)
            {
                throw new Segment.PublicApi.Client.ApiException(400, "Missing required parameter 'previewAudienceInput' when calling AudiencesApi->PreviewAudience");
            }
            ...
            localVarRequestOptions.PathParameters.Add("spaceId", Segment.PublicApi.Client.ClientUtils.ParameterToString(spaceId)); // path parameter
            localVarRequestOptions.Data = previewAudienceInput;

            localVarRequestOptions.Operation = "AudiencesApi.PreviewAudience";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<PreviewAudience200Response>("/spaces/{spaceId}/audiences/previews", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PreviewAudience", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PreviewAudience200Response</returns>
        public async System.Threading.Tasks.Task<PreviewAudience200Response> PreviewAudienceAsync(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Segment.PublicApi.Client.ApiResponse<PreviewAudience200Response> localVarResponse = await PreviewAudienceWithHttpInfoAsync(spaceId, previewAudienceInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PreviewAudience200Response)</returns>
        public async System.Threading.Tasks.Task<Segment.PublicApi.Client.ApiResponse<PreviewAudience200Response>> PreviewAudienceWithHttpInfoAsync(string spaceId, PreviewAudienceInput previewAudienceInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PreviewAudience200Response>("/spaces/{spaceId}/audiences/previews", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
