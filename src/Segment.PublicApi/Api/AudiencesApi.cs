...
namespace Segment.PublicApi.Api
{
    ...
    public interface IAudiencesApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Segment.PublicApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="spaceId"></param>
        /// <param name="message">Optional message to echo back.  This parameter exists in alpha. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetAudienceEcho200Response</returns>
        GetAudienceEcho200Response GetAudienceEcho(string spaceId, string? message = default(string?), int operationIndex = 0);
        ...
        /// <param name="message">Optional message to echo back.  This parameter exists in alpha. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetAudienceEcho200Response</returns>
        ApiResponse<GetAudienceEcho200Response> GetAudienceEchoWithHttpInfo(string spaceId, string? message = default(string?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IAudiencesApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetAudienceEcho200Response</returns>
        System.Threading.Tasks.Task<GetAudienceEcho200Response> GetAudienceEchoAsync(string spaceId, string? message = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetAudienceEcho200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetAudienceEcho200Response>> GetAudienceEchoWithHttpInfoAsync(string spaceId, string? message = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Audience Preview
        /// </summary>
        /// <remarks>
    ...
    public partial class AudiencesApi : IAudiencesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetAudienceEcho200Response</returns>
        public GetAudienceEcho200Response GetAudienceEcho(string spaceId, string? message = default(string?), int operationIndex = 0)
        {
            Segment.PublicApi.Client.ApiResponse<GetAudienceEcho200Response> localVarResponse = GetAudienceEchoWithHttpInfo(spaceId, message);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetAudienceEcho200Response</returns>
        public Segment.PublicApi.Client.ApiResponse<GetAudienceEcho200Response> GetAudienceEchoWithHttpInfo(string spaceId, string? message = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
                throw new Segment.PublicApi.Client.ApiException(400, "Missing required parameter 'spaceId' when calling AudiencesApi->GetAudienceEcho");
            }
            ...
            localVarRequestOptions.Operation = "AudiencesApi.GetAudienceEcho";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetAudienceEcho200Response>("/spaces/{spaceId}/audiences/echo", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAudienceEcho", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetAudienceEcho200Response</returns>
        public async System.Threading.Tasks.Task<GetAudienceEcho200Response> GetAudienceEchoAsync(string spaceId, string? message = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Segment.PublicApi.Client.ApiResponse<GetAudienceEcho200Response> localVarResponse = await GetAudienceEchoWithHttpInfoAsync(spaceId, message, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetAudienceEcho200Response)</returns>
        public async System.Threading.Tasks.Task<Segment.PublicApi.Client.ApiResponse<GetAudienceEcho200Response>> GetAudienceEchoWithHttpInfoAsync(string spaceId, string? message = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetAudienceEcho200Response>("/spaces/{spaceId}/audiences/echo", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
